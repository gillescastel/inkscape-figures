...
This assumes that you use [VimTeX](https://github.com/lervag/vimtex) as it uses the `b:vimtex.root` variable in vim to determine the location of the figures directory.
